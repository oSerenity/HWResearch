...
function DestroyUICommonBress() {
		...
		SceneManagerBresDestroyRequest("UI_dialog.bres");
		SceneManagerBresDestroyRequest("UI_gfxfontlib.bres");
		SceneManagerBresDestroyRequest("UI_keyhelp2.bres");
		SceneManagerBresDestroyRequest("UI_loading.bres");
		SceneManagerBresDestroyRequest("UI_nowloading.bres");
}
