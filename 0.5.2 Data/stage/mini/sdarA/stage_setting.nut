...
function GimmickSetting( stage_seed ) {
	...
	case 0:
		...
		SetGimmickColor( "gbar01_009", POWER_COLOR_WHITE );
		SetGimmickColor( "gbar01_010", POWER_COLOR_WHITE );
		SetGimmickColor( "gbar01_011", POWER_COLOR_WHITE );
		SetGimmickColor( "gbar01_012", POWER_COLOR_WHITE );
		...
		SetGimmickBuild( "gbal01_102", RULE_BUILDING_STATE_COMPLETE );		// 建築済み 
		SetGimmickBuild( "gbal01_103", RULE_BUILDING_STATE_COMPLETE );		// 建築済み 
		SetGimmickBuild( "gbal01_108", RULE_BUILDING_STATE_COMPLETE );		// 建築済み 
